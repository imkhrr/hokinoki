    ...
    return (
        <div className="is-bg-white px-2 py-3" style={{ minHeight: "100vh" }}>
            ...
            <Nav vertical>
                ...
                <Nav.Item componentClass={NavLink} activeClassName="rs-nav-item-active" to="/transactions" icon={<Icon className="is-green" icon="shopping-cart" />}>
            ...
            <Restricted forRole="cashier">
                ...
                <Nav vertical>
                    ...
                    <Nav.Item componentClass={NavLink} activeClassName="rs-nav-item-active" to="/storehouse" icon={<Icon className="is-brown" icon="cube" />}>
